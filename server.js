...
function fallbackAnalysis(profile, userProfile) {
  ...
  return {
    ...
    routes: [
      { name: "名校冲刺路线", label: "上限更高", summary: "保留少量高竞争项目，重点靠文书、推荐信和经历包装争取上限。" },
      { name: "稳妥录取路线", label: "更稳", summary: "优先选择课程匹配、规则透明、录取更稳的项目，把录取结果先拿住。" },
      { name: "就业优先路线", label: "更适合你", summary: "优先看课程和行业连接、实习机会、地区资源与毕业后去向。" }
    ],
    careerPaths: [
      { name: "课程和岗位强匹配路径", label: "结果更直接", summary: "先选能直接补目标行业技能的项目，让毕业去向更容易落地。" },
      { name: "实习与地区资源联动路径", label: "就业更强", summary: "优先去实习机会、校友网络和招聘市场更友好的地区和项目。" },
      { name: "保留长期选择权路径", label: "长期更灵活", summary: "如果未来想继续升学或转方向，先选能给后续机会留出空间的项目。" }
    ],
    insights: [
